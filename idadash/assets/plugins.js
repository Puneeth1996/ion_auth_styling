   ...
   $(".nav-collapsible .navbar-toggler").click(function() {
      ...
      if (
         ...
         $(this)
            ...
            $("#navlogo").attr('src','/assets/logo.png');
            $("#welcome").css('margin-left','270px');
            $("#reportFrame").attr('width',$('.card-content').width()-60);
         ...
         $(this)
            .children()
            .text("radio_button_unchecked");
        $("#navlogo").attr('src','/assets/logo-min.png');
        $("#welcome").css('margin-left','100px');
        $("#reportFrame").attr('width',$('.card-content').width()-60);
...
function resizetable() {
   /*if($(window).width() < 976){
      if($('.vertical-layout.vertical-gradient-menu .sidenav-dark .brand-logo').length > 0){
         $('.vertical-layout.vertical-gradient-menu .sidenav-dark .brand-logo img').attr('src','/assets/logo.png');
      }
      if($('.vertical-layout.vertical-dark-menu .sidenav-dark .brand-logo').length > 0){
         $('.vertical-layout.vertical-dark-menu .sidenav-dark .brand-logo img').attr('src','/assets/logo.png');
      }
      if($('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo').length > 0){
         $('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo img').attr('src','/assets/logo.png');
      }
   }
   else{
      if($('.vertical-layout.vertical-gradient-menu .sidenav-dark .brand-logo').length > 0){
